...
\draw[lI] ([yshift=-5]Sheet.west) -| ([yshift=5]8.5,10) -- ([yshift=5]Imain.west);

\draw[lI] ([yshift=5]Sheet.west) -| ([yshift=-5,xshift=5]8.5,10) -- ([yshift=-5]Imain.west);

\draw[lE] ([xshift=5]Tool.south) |- ([yshift=-5]Sheet.east);
\draw[lE] ([yshift=5]Sheet.east) -| ([xshift=-5]Tool.south);

\draw[lE] (Tool) |- ([yshift=5]11,11.2) -| ([xshift=-5]Imain.north);
...
\draw[li] ([xshift=-7,yshift=-3]Sheet.north) |- ([yshift=-2]11,11.2) -| ([xshift=5,yshift=2]Imain.north);
